...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section class="section-padding"><div class="container"><div class="space-y-6"><div class="text-center mb-8 lg:mb-12"><h1 class="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold text-red-600 mb-4 lg:mb-6"> Payment Error </h1>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/frontend/Pages/PaymentError.vue");
