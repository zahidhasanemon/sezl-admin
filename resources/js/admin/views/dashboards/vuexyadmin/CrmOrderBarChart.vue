...
const ordersCount = computed(() => props.data.orders_today?.count || 0)
const ordersChange = computed(() => props.data.orders_today?.change || 0)
...
<template>
  <VCard>
    <VCardItem class="pb-3">
      ...
      <VCardSubtitle>Today</VCardSubtitle>
    </VCardItem>
    ...
    <VCardText>
      ...
      <div class="d-flex align-center justify-space-between gap-x-2 mt-3">
        ...
        <div
          :class="{
            'text-sm': true,
            'text-success': ordersChange > 0,
            'text-error': ordersChange < 0,
          }"
        >
